...
const Header = () => {
  ...
  return (
    <header className="sticky top-0 flex items-center justify-between p-3 bg-white shadow-md z-30 w-full">
      ...
      <div className="flex-1 flex items-center justify-end space-x-4">
        ...
        <div className="relative">
          ...
          >
            ...
            <span className="text-gray-700 font-semibold">Mukul</span>
            <ChevronDown
