import {
  AddVehicleFormData,
  AddVehicleProps,
} from '@/modules/vehicle-management/model/AddVehicle.interface.ts';
import FlexTextInput from '@/modules/ui/components/FlexTextInput';
import React, { useState } from 'react';
import { INITIAL_ADD_VEHICLE_FORM_DATA } from '@/modules/vehicle-management/data/AddVehicle.data.ts';
import FlexButton from '@/modules/ui/components/FlexButton.tsx';
import { useDispatch, useSelector } from 'react-redux';
import { AppDispatch, RootState } from '@/store/store.ts';
import { addVehicle } from '@/modules/vehicle-management/vehicleManagementSlice.ts';
